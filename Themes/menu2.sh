...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/statushariini"
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/izin | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/izin | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
#######PERIZINAN
BURIQ () {
    curl -sS https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/izin | grep $MYIP | awk '{print $2}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/SatanTech/Autoscript-Premium/main/izin | grep $MYIP | awk '{print $3}')
fi
